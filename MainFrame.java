    ...
    public MainFrame() {
        ...
        storyList.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) { // Double click 
                    ...
                    if (index != -1) {
                        Story selectedStory = storyManager.getStoryList().get(index);
        ...
        addButton.addActionListener((ActionEvent e) -> {
            ...
            if (title != null && author != null && genre != null && content != null) {
                ...
                listModel.addElement(story);
                storyManager.saveToFile(); // Auto save  adding
            }
        });
        ...
        editButton.addActionListener((ActionEvent e) -> {
            ...
            if (index != -1) {
                ...
                if (title != null && author != null && genre != null && content != null) {
                    ...
                    storyManager.saveToFile(); // Auto save  editing
                }
            }
        });
        ...
        deleteButton.addActionListener((ActionEvent e) -> {
            ...
            if (index != -1) {
                ...
                storyManager.saveToFile(); // Auto save  deleting
            }
        });
